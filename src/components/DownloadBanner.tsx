      ...
      >
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          <a
            ...
            className="flex items-center gap-2 bg-white text-blue-700 px-5 py-3 rounded-full font-semibold shadow hover:scale-105 transition-transform"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-green-500 text-white px-5 py-3 rounded-full font-semibold shadow hover:scale-105 transition-transform"
          >
